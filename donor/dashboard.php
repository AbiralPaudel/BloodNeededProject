<?php
    ...
    // Removed "donate_money" from this check as it will now redirect directly
...
<body style="background-color: #f5f5dc;">
    ...
    <a class="navbar-brand" href="../index.php" style="color: #777;font-size:22px;letter-spacing:2px;">RAGATCHAIYO</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                ...
                <!-- Changed href to point directly to donatemoney.php -->
                <li class="nav-item">
                    <a class="nav-link" href="donatemoney.php">Donate Money</a>
                </li>
                <li>
                    <?php
                    echo 
    ...
    <?php
        ...
        if(isset($_GET))
        {
            ...
            else if (count($_GET) === 1) // Ensure there is exactly one GET parameter
            {
                $getOne = key($_GET);
            }
        }
